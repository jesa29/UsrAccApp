...
folder are mapped to the application's root namespace, 'useraccountapplication'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "useraccountapplication"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'useraccountapplication' in the same way
as `"useraccountapplication/sass/src"`.
